...
class TestPE1603REGISTERINVPASS():
    ...
    def test_pE1603REGISTERINVPASS(self):
        ...
        self.driver.find_element(By.NAME, "email").send_keys(
            "emailtest@email.com")
        # Password entered is only 4 characters long
        self.driver.find_element(By.ID, "password").send_keys("pass")
        self.driver.find_element(By.ID, "cpassword").send_keys("pass")
